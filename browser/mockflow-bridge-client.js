		...
		ws.onmessage = function(ev) {
			...
			switch (frame.t) {
				...
				case 'plan-pick':
					...
					return;
				case 'media-ask':
					// "Generate images?" - the production editor asks the user in the
					// chat, because the images are generated by MockFlow AI against
					// their credits. A generic/test page has neither that UI nor a way
					// to fill the slots, so answer no and let the draw proceed.
					reply(frame.id, true, { withImages: false });
					return;
				case 'error':
